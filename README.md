...
Messaging with services such as Azure Storage queues and Azure Service Bus available as dotnet libraries. 
I'm generally using MassTransit now for services like Azure Service Bus.
